...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { contraseña: @empresa.contraseña, correo: @empresa.correo, nombre: @empresa.nombre, rif: @empresa.rif } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { contraseña: @empresa.contraseña, correo: @empresa.correo, nombre: @empresa.nombre, rif: @empresa.rif } }
